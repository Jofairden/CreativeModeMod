...
namespace CreativeMode.Commands.Handling.Godmode
{
    class GodmodePlayer : ModPlayer
    {
        int[] debuffList =
        {
            BuffID.Bleeding,
        ...
        public override bool CanBeHitByNPC(Terraria.NPC npc, ref int cooldownSlot)
        {
        ...
        public override void ModifyHitNPCWithProj(Projectile proj, Terraria.NPC target, ref int damage, ref float knockback, ref bool crit)
        {
            if (CreativeMode.GM)
            {
                damage *= 4;
